            ...
            filteredOrders.map(order => (
              ...
              >
                <h2 className="text-lg sm:text-xl font-semibold flex items-center">
                  <FaUtensils className="mr-2" style={{ color: '#b45309' }} /> Table {order.tableId} (Order #{order.orderNumber})
                </h2>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-lg">
            <h2 className="text-xl sm:text-2xl font-bold mb-4 flex items-center">
              <FaEdit className="mr-2" style={{ color: '#b45309' }} /> Edit Order - Table {editingOrder.tableId} (Order #{editingOrder.orderNumber})
            </h2>
            <div className="space-y-4">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  ].filter(item => item.itemId); // Ensure no undefined items
                  setEditingOrder({ ...editingOrder, items: newItems });
                }}
